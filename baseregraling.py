...
ID_PLANILHA = "1qO_3WQkEnDI__xCLT_hsYWg0hYfRWpL2eCCf26QJLrs/edit?gid=0#gid=0"
...
with abas[0]:
    ...
    if st.button("Salvar entrada"):
        if projeto and analista and titulo_regra and regra:
            nova_linha = [projeto, analista, titulo_regra, regra, ferramenta, data or datetime.today().strftime('%Y-%m-%d')]
