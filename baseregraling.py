...
CAMINHO_CREDENCIAL = "dappbaseregrasling-eab98112b3ba.json"  # coloque o nome correto do seu arquivo
    ...
    if st.button("Salvar entrada"):
        if projeto and analista and titulo_regra and regra:
            ...
            try:
                ...
                sheet = conectar_planilha()  # Reestabelece a conexão com a planilha
